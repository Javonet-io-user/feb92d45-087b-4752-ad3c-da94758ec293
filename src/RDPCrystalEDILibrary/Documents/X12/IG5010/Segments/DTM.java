...
public class DTM extends DocumentSegment {
  ...
  public java.lang.String getDateTimeQualifier() {
    try {
      java.lang.String res = javonetHandle.get("DateTimeQualifier");
      if (res == null) return "";
  ...
  public java.lang.String getTimeCode() {
    try {
      java.lang.String res = javonetHandle.get("TimeCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public DTM() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.DTM");
