...
public class CN1 extends DocumentSegment {
  ...
  public java.lang.String getContractTypeCode() {
    try {
      java.lang.String res = javonetHandle.get("ContractTypeCode");
      if (res == null) return "";
  ...
  public java.lang.String getPercent() {
    try {
      java.lang.String res = javonetHandle.get("Percent");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getTermsDiscountPercent() {
    try {
      java.lang.String res = javonetHandle.get("TermsDiscountPercent");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public CN1() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.CN1");
