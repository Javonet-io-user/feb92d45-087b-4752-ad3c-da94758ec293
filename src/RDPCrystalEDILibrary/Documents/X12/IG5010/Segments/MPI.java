...
public class MPI extends DocumentSegment {
  ...
  public java.lang.String getInformationStatusCode() {
    try {
      java.lang.String res = javonetHandle.get("InformationStatusCode");
      if (res == null) return "";
  ...
  public java.lang.String getGovernmentServiceAffiliationCode() {
    try {
      java.lang.String res = javonetHandle.get("GovernmentServiceAffiliationCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getMilitaryServiceRankCode() {
    try {
      java.lang.String res = javonetHandle.get("MilitaryServiceRankCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public MPI() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.MPI");
