...
public class IK3 extends DocumentSegment {
  ...
  public java.lang.String getImplementationSegmentSyntaxErrorCode() {
    try {
      java.lang.String res = javonetHandle.get("ImplementationSegmentSyntaxErrorCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public IK3() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.IK3");
