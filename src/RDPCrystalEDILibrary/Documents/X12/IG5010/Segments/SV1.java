...
public class SV1 extends DocumentSegment {
  ...
  public java.lang.String getUnitOrBasisForMeasurementCode() {
    try {
      java.lang.String res = javonetHandle.get("UnitOrBasisForMeasurementCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getMultipleProcedureCode() {
    try {
      java.lang.String res = javonetHandle.get("MultipleProcedureCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getReviewCode() {
    try {
      java.lang.String res = javonetHandle.get("ReviewCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getNationalOrLocalAssignedReviewValue() {
    try {
      java.lang.String res = javonetHandle.get("NationalOrLocalAssignedReviewValue");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getHealthCareProfessionalShortageAreaCode() {
    try {
      java.lang.String res = javonetHandle.get("HealthCareProfessionalShortageAreaCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getPostalCode() {
    try {
      java.lang.String res = javonetHandle.get("PostalCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getLevelOfCareCode() {
    try {
      java.lang.String res = javonetHandle.get("LevelOfCareCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public SV1() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.SV1");
