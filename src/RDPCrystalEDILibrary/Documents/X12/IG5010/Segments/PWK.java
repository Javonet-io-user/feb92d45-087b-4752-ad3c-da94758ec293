...
public class PWK extends DocumentSegment {
  ...
  public java.lang.String getReportTypeCode() {
    try {
      java.lang.String res = javonetHandle.get("ReportTypeCode");
      if (res == null) return "";
  ...
  public java.lang.String getReportCopiesNeeded() {
    try {
      java.lang.String res = javonetHandle.get("ReportCopiesNeeded");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PWK() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.PWK");
