...
public class ICM extends DocumentSegment {
  ...
  public java.lang.String getFrequencyCode() {
    try {
      java.lang.String res = javonetHandle.get("FrequencyCode");
      if (res == null) return "";
  ...
  public java.lang.String getLocationIdentifier() {
    try {
      java.lang.String res = javonetHandle.get("LocationIdentifier");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getSalaryGrade() {
    try {
      java.lang.String res = javonetHandle.get("SalaryGrade");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ICM() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.ICM");
