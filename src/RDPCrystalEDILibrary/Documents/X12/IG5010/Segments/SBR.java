...
public class SBR extends DocumentSegment {
  ...
  public java.lang.String getPayerResponsibilitySequenceNumberCode() {
    try {
      java.lang.String res = javonetHandle.get("PayerResponsibilitySequenceNumberCode");
      if (res == null) return "";
  ...
  public void setNameAsSBR(java.lang.String value) {
    try {
  ...
  public java.lang.String getNameAsSBR() {
    try {
  ...
  public java.lang.String getCoordinationOfBenefitsCode() {
    try {
      java.lang.String res = javonetHandle.get("CoordinationOfBenefitsCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public SBR() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.SBR");
