...
public class SV2 extends DocumentSegment {
  ...
  public java.lang.String getProductOrServiceID() {
    try {
      java.lang.String res = javonetHandle.get("ProductOrServiceID");
      if (res == null) return "";
  ...
  public java.lang.String getUnitRate() {
    try {
      java.lang.String res = javonetHandle.get("UnitRate");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public SV2() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.SV2");
