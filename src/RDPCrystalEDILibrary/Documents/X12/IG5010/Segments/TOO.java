...
public class TOO extends DocumentSegment {
  ...
  public java.lang.String getToothCode() {
    try {
      java.lang.String res = javonetHandle.get("ToothCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ToothSurface getToothSurface() {
    try {
      Object res = javonetHandle.<NObject>get("ToothSurface");
      if (res == null) return null;
      return new ToothSurface((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public TOO() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.TOO");
