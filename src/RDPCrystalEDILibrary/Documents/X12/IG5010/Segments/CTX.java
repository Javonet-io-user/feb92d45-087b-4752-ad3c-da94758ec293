...
public class CTX extends DocumentSegment {
  ...
  public ContextIndentification getContextIndentification() {
    try {
      Object res = javonetHandle.<NObject>get("ContextIndentification");
      if (res == null) return null;
      return new ContextIndentification((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public java.lang.String getSegmentIDCode() {
    try {
      java.lang.String res = javonetHandle.get("SegmentIDCode");
      if (res == null) return "";
  ...
  public java.lang.String getSegmentPositionInTransactionSet() {
    try {
      java.lang.String res = javonetHandle.get("SegmentPositionInTransactionSet");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PositionInSegment getPositionInSegment() {
    try {
      Object res = javonetHandle.<NObject>get("PositionInSegment");
      if (res == null) return null;
      return new PositionInSegment((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ReferenceInSegment getReferenceInSegment() {
    try {
      Object res = javonetHandle.<NObject>get("ReferenceInSegment");
      if (res == null) return null;
      return new ReferenceInSegment((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public CTX() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.CTX");
