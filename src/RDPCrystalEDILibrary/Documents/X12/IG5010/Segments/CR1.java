...
public class CR1 extends DocumentSegment {
  ...
  public java.lang.String getWeight() {
    try {
      java.lang.String res = javonetHandle.get("Weight");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getAmbulanceTransportCode1() {
    try {
      java.lang.String res = javonetHandle.get("AmbulanceTransportCode1");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getAmbulanceTransportReasonCode() {
    try {
      java.lang.String res = javonetHandle.get("AmbulanceTransportReasonCode");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getAddress1() {
    try {
      java.lang.String res = javonetHandle.get("Address1");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getAddress2() {
    try {
      java.lang.String res = javonetHandle.get("Address2");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public CR1() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("RDPCrystalEDILibrary.Documents.X12.IG5010.Segments.CR1");
